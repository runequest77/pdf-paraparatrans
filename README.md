...
> ### ⚠️ 注 意 ⚠️
> リリースされているv0.5.0まではport:5000を使用していましたが、5000が競合する環境があるようなのでport:5077に変更予定です。
> 現在mainブランチはport:5077になっていますのでソースをpullして使う方はご注意ください。
...
## 更新履歴（★は破壊的なバージョン変更）
- v0.6.0: 2025/03/30 目次パネル実装。テキスト中にタグと解釈しうるエラーが含まれていた場合エラーになっていたバグを修正。
